...
> Ported from upstream phono. BrightMusic is Spotify-only — the TIDAL rows below are kept because
> they are evidence about what other downloaders do, not because this fork has a TIDAL backend.

Research note for BrightMusic album/playlist pins. Mature unofficial Spotify and TIDAL
