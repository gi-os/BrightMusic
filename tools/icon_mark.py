#!/usr/bin/env python3
"""Build BrightMusic's launcher mark.
...
MARK = [
    ('M24.00,54.00 A30.00,30.00 0 1 1 84.00,54.00 A30.00,30.00 0 1 1 24.00,54.00 Z', 5, False),
    ('M43.00,54.00 A11.00,11.00 0 1 1 65.00,54.00 A11.00,11.00 0 1 1 43.00,54.00 Z', 5, False),
    ('M50.50,54.00 A3.50,3.50 0 1 1 57.50,54.00 A3.50,3.50 0 1 1 50.50,54.00 Z', 0, False),
]
...
<!--
  BrightMusic launcher mark. One of the unified Bright* set: 108 canvas, 18..90
